...
작동만 되게끔 완성하는거는 사실 부록에서 오타 몇 개 잡고 잘 이어붙히면 되는거라 사실 별 일이 아니였습니다만, 혼자 힘으로는 제 기간내에 완성을 못한 학생들이 의외로 꽤나 있었습니다

**과제 점수에는 보고서를 잘 쓰는것이 훨씬 중요했습니다**

1. 모든 수정사항 및 디버깅 기록 전부 보고서에 집어넣기
2. 최대한 많은 테스트를 해보기
    - 가능한 모든 경우를 테스트해보기
    - 다양한 오류를 내보기
...
적어도 코드에 틀린 부분은 없다 자신합니다, 이 코드들 가지고서 보고서 잘 써내기만 하면 될거에요
