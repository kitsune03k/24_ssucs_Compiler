...
void prt_sem_program(A_NODE *node, int s) {
    ...
    switch (node->name) {
        ...
        case N_PROGRAM:
            ...
            break;
        default :
            printf("****syntax tree error****** - prt_sem_program\n");
    }
}
...
void prt_sem_initializer(A_NODE *node, int s) {
    ...
    switch (node->name) {
        ...
        case N_INIT_LIST_NIL:
            break;
        default :
            printf("****syntax tree error****** - prt_sem_initializer\n");
    }
}
...
void prt_sem_expression(A_NODE *node, int s) {
    ...
    switch (node->name) {
        ...
        case N_EXP_ASSIGN :
            ...
            break;
        default :
            printf("****syntax tree error****** - prt_sem_expression\n");
    }
}
...
void prt_sem_arg_expr_list(A_NODE *node, int s) {
    ...
    switch (node->name) {
        ...
        case N_ARG_LIST_NIL :
            break;
        default :
            printf("****syntax tree error****** - prt_sem_arg_expr_list\n");
    }
}
...
void prt_sem_statement(A_NODE *node, int s) {
    ...
    switch (node->name) {
        ...
        case N_STMT_RETURN:
            ...
            break;
        default :
            printf("****syntax tree error****** - prt_sem_statement\n");
    }
}
...
void prt_sem_statement_list(A_NODE *node, int s) {
    ...
    switch (node->name) {
        ...
        case N_STMT_LIST_NIL:
            break;
        default :
            printf("****syntax tree error****** - prt_sem_statement_list\n");
...
void prt_sem_for_expression(A_NODE *node, int s) {
    ...
    switch (node->name) {
        ...
        case N_FOR_EXP :
            ...
            break;
        default :
            printf("****syntax tree error****** - prt_sem_for_expression\n");
    }
}
